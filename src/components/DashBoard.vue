<template>
<div class="flex-col overflow-y-hidden">
    <ComponentName name="Dashboard" />
    <div class="h-56 flex bg-pink-50 px-6">
        <div class="flex-grow w-28 flex bg-gradient-to-r rounded-t-2xl rounded-b-2xl from-pink-400 to-purple-500 m-5">
        ...
        <div class="flex-grow w-28 flex bg-gradient-to-r rounded-t-2xl rounded-b-2xl from-blue-400 to-green-500 m-5">
            <div class="flex-col flex-grow">
        ...
        <div class="flex-grow w-28 flex bg-gradient-to-r rounded-t-2xl rounded-b-2xl from-yellow-400 to-red-500 m-5">
            <div class="flex-col flex-grow">
