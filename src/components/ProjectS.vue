<template>
<div class="outer overflow-y-scroll" id="outerContainer">
    <div id="container" ref="scrollbarContainer">
...
export default {
    ...
    data() {
        return {
            ...
            teacherFlag: false,
            user: null,
            ps: null // Perfect Scrollbar instance
        };
    },
    mounted() {
    ...
    methods: {
        ...
        initPerfectScrollbar() {
            this.ps = new PerfectScrollbar(this.$refs.scrollbarContainer, {
                // handlers : "wheel",
                wheelSpeed: 1,
